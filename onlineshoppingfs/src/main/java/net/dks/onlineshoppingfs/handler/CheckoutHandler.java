...
import net.dks.onlineshoppingfs.model.CheckoutModel;
...
import net.dks.shoppingbackendfs.dto.OrderItem;
...
System.out.println("iNSIDE CHECKOUT HANDLER");
	...
	public List<Address> getShippingAddresses(CheckoutModel model) {
		System.out.println("iNSIDE CHECKOUT HANDLER-list address");
				
		List<Address> addresses = userDAO.listShippingAddress(model.getUser());
			System.out.println("iNSIDE CHECKOUT HANDLER-list address before if condition");
